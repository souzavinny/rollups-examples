...
import { ModalCloseButton, ModalContent, ModalContentWrapper, ModalWrapper } from "./modal.style";
...
export const Modal: FC<PropsWithChildren<IModal>> = ({
    ...
    const closeModalFadeoutTransitionDelayInSeconds = (MODAL_FADEOUT_DELAY - 100)/1000;
