...
This project demonstrates how to implement a web application UI to interact with [m2cgen](../m2cgen/) DApp, both running locally and deployed on remote testnet networks.
...
In general terms, the Titanic Survivor offers an interactive, web responsive and enjoyable UI which communicates with the m2cgen DApp through a simple three inputs based forms, authenticated by a web 3.0 wallet.
